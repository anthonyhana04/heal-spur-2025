  ...
  return (
    <div className='h-screen animated-gradient relative flex flex-col items-center justify-center p-4'>
      ...
      <div className='flex flex-row items-center justify-center w-full gap-8 mb-8'>
        {/* Webcam on the left */}
        <div className='w-[600px] h-[600px] rounded-3xl overflow-hidden bg-black relative'>
          {turnOnCam ? (
            <>
              <Webcam
                audio={false}
        ...
        <div className='w-[600px] h-[600px] rounded-3xl border-4 border-dashed border-gray-600 relative'>
          <div 
